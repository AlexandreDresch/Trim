...
async function seedDatabase() {
  try {
    ...
    const addresses = [
      ...
      "789 Beard Plaza",
      "101 Razor Alley",
      "202 Styles Boulevard",
      "303 Machete Road",
      "404 Elegant Avenue",
      "505 Appearance Plaza",
      "606 Urban Street",
      "707 Classic Avenue",
    ];
    ...
    const services = [
      ...
      {
        name: "Beard",
        description: "Complete modeling to highlight your masculinity.",
        price: 8.0,
        imageUrl:
      ...
      {
        name: "Eyebrow",
        description: "Accentuated expression with precise modeling.",
        price: 4.0,
        imageUrl:
    ...
    console.error("Error while creating barbershops:", error);
  }
}
